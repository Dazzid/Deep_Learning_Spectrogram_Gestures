...
def evaluate_model(trainX, trainy, testX, testy):
    ...
    model.add(tf.keras.layers.Conv1D(1024, 10, activation='relu', input_shape=(n_timesteps,n_features)))
    model.add(tf.keras.layers.Conv1D(512, 10, activation='relu'))
...
def run_experiment(repeats=10):
    ...
    plt.savefig('figures/Confusion_Matrix_CNN_Con1D.png')
    plt.show()
